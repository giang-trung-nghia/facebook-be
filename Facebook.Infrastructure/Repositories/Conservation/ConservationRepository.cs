...
{
    public class ConservationRepository : BaseRepository<ConservationEntity>, IConservationRepository
    {
        private readonly AppDbContext _context;

        public ConservationRepository(AppDbContext context) : base(context)
        {
            _context = context;
        }
    }
